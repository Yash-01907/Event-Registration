    ...
    <div className='min-h-screen gradient-mesh pt-20 pb-12'>
      ...
      <div className='container mx-auto px-4 relative z-10'>
              ...
              >
                ...
                <div className='p-5 flex-grow flex flex-col'>
                  ...
                  <div className='space-y-2 text-sm text-gray-500 mb-5 flex-grow font-mono'>
                    ...
                    <div className='flex items-center gap-2'>
                      <span className='h-4 w-4 flex items-center justify-center text-emerald-400 font-bold text-xs'>
                        ₹
                      </span>
                      <span>
        ...
        <ConfirmDialog
          ...
          description={
            selectedReg
              ? `Are you sure you want to cancel your registration for "${selectedReg.event?.name}"? This cannot be undone.`
              : ''
          }
