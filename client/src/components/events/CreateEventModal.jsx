        ...
        <form onSubmit={handleSubmit(onSubmit)} className='space-y-4'>
          ...
          <div>
            ...
            >
              ...
              <option value='COMPUTER' className='bg-gray-900'>
                Computer
              </option>
              <option value='ELECTRICAL' className='bg-gray-900'>
                Electrical
              </option>
              <option value='MECHANICAL' className='bg-gray-900'>
                Mechanical
              </option>
              <option value='CIVIL' className='bg-gray-900'>
                Civil
              </option>
            ...
            <div className='animate-in fade-in slide-in-from-top-2'>
              ...
              >
                ...
                {[1, 2, 3, 4, 5, 6, 7, 8].map((sem) => (
                  <option key={sem} value={sem} className='bg-gray-900'>
                    {sem}
                  </option>
                ))}
              </select>
