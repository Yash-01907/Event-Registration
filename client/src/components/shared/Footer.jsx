        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-500 leading-relaxed max-w-sm text-sm">
              The ultimate convergence of technology, sports, and culture.
              Join thousands of students in this electrifying event.
            </p>
            {/* Social Links */}
            <div className="flex items-center gap-4 pt-2">
              ...
              <a href="#" className="text-gray-600 hover:text-fuchsia-400 transition-colors">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              ...
              <li>
                <button className="text-gray-500 hover:text-cyan-400 transition-colors text-sm">
                  Contact Us
                </button>
              </li>
              <li>
